...
S_UPPER_SRCS += \
../system/src/cmsis/startup_stm32f107xc.S 

OBJS += \
./system/src/cmsis/startup_stm32f107xc.o \
./system/src/cmsis/system_stm32f1xx.o 

S_UPPER_DEPS += \
./system/src/cmsis/startup_stm32f107xc.d 
...
system/src/cmsis/%.o: ../system/src/cmsis/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra  -g -x assembler-with-cpp -DUSE_HAL_LIBRARY -DDEBUG -DTRACE -DSTM32F107xC -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f1xx" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
