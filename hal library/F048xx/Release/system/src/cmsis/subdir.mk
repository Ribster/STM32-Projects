...
S_UPPER_SRCS += \
../system/src/cmsis/startup_stm32f048xx.S 

OBJS += \
./system/src/cmsis/startup_stm32f048xx.o \
./system/src/cmsis/system_stm32f0xx.o 

S_UPPER_DEPS += \
./system/src/cmsis/startup_stm32f048xx.d 
...
system/src/cmsis/%.o: ../system/src/cmsis/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra  -g -x assembler-with-cpp -DUSE_HAL_LIBRARY -DDEBUG -DSTM32F048xx -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f0xx" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
