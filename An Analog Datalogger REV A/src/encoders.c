...
static volatile int16_t encoder_parameterEncoderOneTotal;
static volatile int16_t encoder_parameterEncoderTwoTotal;
...
initialize_encoderOne(void){
	...
	TIM_EncoderInterfaceConfig (ENC_1_TIMER, TIM_EncoderMode_TI1,
								TIM_ICPolarity_Falling,
								TIM_ICPolarity_Falling);
	TIM_ARRPreloadConfig(ENC_1_TIMER, ENABLE);
...
initialize_encoderTwo(void){
	...
	TIM_EncoderInterfaceConfig (ENC_2_TIMER, TIM_EncoderMode_TI1,
								TIM_ICPolarity_Falling,
								TIM_ICPolarity_Falling);
	TIM_ARRPreloadConfig(ENC_2_TIMER, ENABLE);
...
encoder_resetEncoderOne(void){
	...
	encoder_parameterEncoderOneTotal = 0;
...
encoder_resetEncoderTwo(void){
	...
	encoder_parameterEncoderTwoTotal = 0;
...
encoder_getEncoderOneValue(void){
	return encoder_parameterEncoderOneTotal;
}
int16_t
encoder_getEncoderTwoValue(void){
	return encoder_parameterEncoderTwoTotal;
}
