...
#define AFE_DUMMY_BIG
	...
	#undef AFE_DUMMY_SMALL
#endif



#define AFE_DMA_BLOCKSIZE 512
...
#define OLED_SUBMENUWRITING_SPACINGPIXELS_FROMSUBITEMS 2
	...
	// here the orientation of stepping is from user viewpoint
		// pointerwise: UP-> left, DOWN->right, BACK->up, ENTER->down
#define OLED_MENU_STEP_UP 0x00
#define OLED_MENU_STEP_DOWN 0x01
#define OLED_MENU_STEP_BACK 0x02
#define OLED_MENU_STEP_ENTER 0x03

#define OLED_MENUWRITING_MINIMUMWIDTH_CHARSIZE 22

#define OLED_TEXTBLOCK_LEFTDOWN_X 0
#define OLED_TEXTBLOCK_LEFTDOWN_Y 0
#define OLED_TEXTBLOCK_LEFTDOWN OLED_TEXTBLOCK_LEFTDOWN_X,OLED_TEXTBLOCK_LEFTDOWN_Y
#define OLED_TEXTBLOCK_RIGHTUP_X 127
#define OLED_TEXTBLOCK_RIGHTUP_Y 53
#define OLED_TEXTBLOCK_RIGHTUP OLED_TEXTBLOCK_RIGHTUP_X,OLED_TEXTBLOCK_RIGHTUP_Y
#define OLED_TEXTBLOCK_DIMENSIONS OLED_TEXTBLOCK_LEFTDOWN,OLED_TEXTBLOCK_RIGHTUP

#define OLED_LINE_DIMENSIONS 0,55,127,55
#define OLED_DELAY_STARTUP 200
